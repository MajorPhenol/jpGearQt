...
class Ui_jpgearqt(object):
    def setupUi(self, jpgearqt):
        ...
        self.gridLayout.addWidget(self.lb_CD, 30, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_46, 30, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_undercut1, 32, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_54, 31, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_GR, 29, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_59, 31, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_2, 33, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.lb_undercut2, 32, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_CR, 31, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_60, 29, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_58, 29, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_52, 30, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_48, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_tt1, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_tt2, 9, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_85, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lb_stressB1, 5, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_14, 7, 0, 1, 4)
        ...
        self.gridLayout_3.addWidget(self.lb_stressB2, 5, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_15, 4, 0, 1, 4)
        ...
        self.gridLayout_3.addWidget(self.le_FW1, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_77, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.le_FW2, 1, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.le_speed, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_76, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.le_torque, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_79, 6, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lb_stressC1, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lb_stressC2, 6, 3, 1, 1)
        ...
        QWidget.setTabOrder(self.tabW_GD, self.pb_useLayout)
        QWidget.setTabOrder(self.pb_useLayout, self.hSlider_Mesh)
        ...
        QWidget.setTabOrder(self.pb_animate, self.le_FW1)
        QWidget.setTabOrder(self.le_FW1, self.le_FW2)
        QWidget.setTabOrder(self.le_FW2, self.le_torque)
        QWidget.setTabOrder(self.le_torque, self.pb_stress)
    ...
    def retranslateUi(self, jpgearqt):
        ...
        self.le_speed.setText(QCoreApplication.translate("jpgearqt", u"1", None))
        self.label_76.setText(QCoreApplication.translate("jpgearqt", u"Bending Stress", None))
        self.le_torque.setText(QCoreApplication.translate("jpgearqt", u"1", None))
